...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(1280, 720, "Simple Addition Maths. Created using GLFW+OpenGL3 example", nullptr, nullptr);
    if (window == nullptr)
        return 1;
...
#endif
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Checkbox("System Settings", &show_demo_window);      // Edit bools storing our window open/close state
